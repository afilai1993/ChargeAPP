...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Widget build(BuildContext context) {
    return GPScaffold(
      appBar: GPAppbar(
        title: GPAppBarTitle(S.current.register),
      ),
      body: Container(
                                ...
                                child: GeneralAuthTextField(
                                  ...
                                  validator: (text) {
                                    if (text == null || text.isBlank) {
                                      return S.current.validate_input_username;
                                    }
                                    return null;
                                  },
  ...
  void submit() {
    if (_formKey.currentState?.validate() == true) {
      uiTask
          ...
          .run(findCase<LoginCase>().register(
  ...
  void retrieveAuthCode() {
    ...
    uiTask
        ...
        .run(findCase<EmailCase>().sendCode(email, SendEmailType.register))
        .onSuccess((result) {
